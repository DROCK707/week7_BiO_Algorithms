...
let solution = numbers[3]

// 👆 this solution has a time complexity of O(1) because the computer does not need to iterate 4 times through the array, but simply call onto the 4th element of the array by calling index[3]
...
// ANSWER: O(n) **************** May contain up to arr.length elements that meet that criteria
...
function getNumbSquaredBetter(numbers) {
  for (let i = 0; i < numbers.length; i++) {
    numbers.splice(i, 0, (numbers[i] * numbers[i]))
  }
  return numbers
}
